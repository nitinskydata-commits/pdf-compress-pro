...
export default function AdminSettings() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-black text-surface-900 tracking-tight">System &amp; Account Settings</h1>
        <p className="text-xs text-surface-500 mt-0.5">Manage branding assets and administrative authentication</p>
      </div>
